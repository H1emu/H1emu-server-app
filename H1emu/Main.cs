    ...
    public partial class Main : MaterialForm
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                switch (hash)
                {
                    case "53a3d98f": // 15 janv 2015
                        this.gameVersion = "15janv2015";
                        break;
                    case "bc5b3ab6": // 22 dec 2016
                        this.gameVersion = "22dec2016";
                        break;
                    default:
                        MessageBox.Show("This version of h1z1 isn't supported by H1emu, sorry...", "H1Emu", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        System.Windows.Forms.Application.Exit();
                        break;
                }
        ...
        private void applyPatch_2015()
        {
            ...
            using (StreamWriter sw = p.StandardInput)
            {
                ...
                {
                    sw.WriteLine("del /q dinput8.dll msvcp140d.dll ucrtbased.dll vcruntime140_1d.dll vcruntime140d.dll");
        ...
        private void applyPatch_Click(object sender, EventArgs e)
        {
            ...
            {
                case "15janv2015":
                    this.applyPatch_2015();
                    break;
                case "22dec2016":
                    this.applyPatch_2016();
                    break;
            }
        }
